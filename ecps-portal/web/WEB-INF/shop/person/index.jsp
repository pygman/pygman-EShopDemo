...
<title>首页_用户中心_移动商城_中国移动通信</title>
...
<div class="w loc">
	...
	<p class="r"><a href="index.html" title="首页">首页</a><samp>&gt;</samp><span class="gray">用户中心</span></p>
...
<div class="w mt ofc">
	<div class="l wl">
		...
		<div class="box bg_gray">
			<ul class="ul left_nav">
			<li><a href="${path }/user/toProfile.form" title="个人资料">个人资料</a></li>
			<li><a href="${path }/user/toAddr.form" title="收货地址">收货地址</a></li>
	...
	<div class="r wr profile">
		...
		<div class="box_orange">
			<dl class="dl_pro">
				<dt><b class="red">${username}</b>，欢迎您！<a href="${base}/editPtlUser.form" title="编辑个人资料" class="blue">编辑个人资料</a></dt>
				<dd>
					<p>总消费额：<b>￥<fmt:formatNumber value="${myTotalCash/100}" pattern="#0.00" /></b></p>
					<p>完成订单数：<b>${mySuccessOrder}</b></p>
					<p>我的订单：<b><a href="${base}/center/orderList.form" title="我的订单：${myOrderNum}">${myOrderNum}</a></b></p>
					<p>我的收藏：<b><a href="${base}/center/favors.form" title="我的收藏：${myFavorNum}">${myFavorNum}</a></b></p>
				</dd>
			</dl>
		</div>

		<h2 class="h2 h2_filter mt"><em>我的订单</em><cite><a href="${base}/center/orderList.form" title="查看全部订单" class="blue">查看全部订单<samp>&gt;&gt;</samp></a></cite></h2>
		...
		<tbody>
			<tr>
				...
				<td>张同来</td>
				<td>￥4999.00</td>
				<td>2012-09-03<br />12:09:45</td>
				<td>备货中</td>
				<td class="blue"><a href="javascript:void(0);" title="查看详情">查看详情</a><br /><a href="javascript:void(0);" title="取消订单">取消订单</a></td>
			</tr>        
			<tr class="over">
				<td><a href="#" title="H7859454">H7859454</a></td>
				<td class="nwp pic">
				...
				<td>￥4999.00</td>
				<td>2012-09-03<br />12:09:45</td>
				<td>配送中<br /><span class="gray">物流单号：<br />02716851742</span></td>
				<td class="blue"><a href="javascript:void(0);" title="查看详情">查看详情</a><br /><a href="javascript:void(0);" title="取消订单">跟踪物流</a></td>
			</tr>
			<tr>
				<td><a href="#" title="H7859454">H7859454</a></td>
				<td class="nwp pic">
				...
				<td>2012-09-03<br />12:09:45</td>
				<td>待付款</td>
				<td class="blue"><a href="javascript:void(0);" title="查看详情">查看详情</a><br /><a href="javascript:void(0);" title="在线支付">在线支付</a></td>
			</tr> 
		</tbody>
		</table>

		<h2 class="h2 h2_filter mt"><em>我的收藏</em><cite><a href="${base}/center/favors.form" title="查看全部订单" class="blue">查看全部收藏<samp>&gt;&gt;</samp></a></cite></h2>
		
		<h2 class="h2 h2_ch mt"><em><a href="javascript:void(0);" title="实体商品" rel="#productTab" class="here">实体商品</a><a href="javascript:void(0);" title="优惠活动" rel="#eventTab">优惠活动</a></em><cite></cite></h2>

		<table cellspacing="0" summary="" id="productTab" class="tab tab4">
			<thead>
				<tr>
					<th width="12%">商品编号</th>
					<th>商品名称</th>
			...
			<tbody>
				<tr>
					...
					<td>2012-09-03<br />12:09:45</td>
					<td>
						 <a href="${staticPath}${item.favUrl}" title="购买" class="inb btn52x21b">购买</a>
						 <br />
						 <input type="button" value="移除" onclick="singleDel('${item.id}','${item.myfavType}')" class="hand btn52x21 mt" />
					</td>
				</tr>
				<tr class="over">
					<td><a href="#" title="H7859454">H7859454</a></td>
		...
		<table cellspacing="0" summary="" id="eventTab" class="tab tab4" style="display:none">
			<thead>
				<tr>
					<th width="12%">商品编号</th>
					<th>活动名称</th>
			...
			<tbody>
				<tr>
					...
					<td>2012-09-03 12:09:45 至<br />2012-09-03 12:09:45</td>
					<td class="nwp">全球通全球通全球通</td>
					<td>
						 <a href="${staticPath}${item.favUrl}" title="购买" class="inb btn52x21b">购买</a>
						 <br />
						 <input type="button" value="移除" onclick="singleDel('${item.id}','${item.myfavType}')" class="hand btn52x21 mt" />
