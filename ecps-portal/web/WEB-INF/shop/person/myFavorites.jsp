...
<title>我的收藏_用户中心_移动商城_中国移动通信</title>
...
<div class="w loc">
	...
	<p class="r"><a href="index.jsp" title="首页">首页</a><samp>&gt;</samp><a href="../person/index.jsp" title="用户中心">用户中心</a><samp>&gt;</samp><span class="gray">我的收藏</span></p>
...
<div class="w mt ofc">
	<div class="l wl">
		...
		<div class="box bg_gray">
			...
			<li><a href="../person/myFavorites.jsp" title="我的收藏" class="here">我的收藏</a></li>
			</ul>
		</div>
	...
	<div class="r wr profile">
		...
		<form method="post" action="" name="">
			...
			<div class="tool">查询：<select name=""><option selected value="选择商品类型" selected>选择商品类型</option><option value="实体商品">实体商品</option><option value="营销案">营销案</option></select><input type="text" id="orderSearch" name="orderSearch" onfocus="if(this.value=='请输入商品名称'){this.value='';this.className='txts'}" onblur="if(this.value==''){this.value='请输入商品名称';this.className='gray txts'}" value="请输入商品名称" size="28" class="gray txts" /><input type="submit" value="查 询" class="hand btn66x23" /></div>

			<h2 class="h2 h2_ch"><em><a href="javascript:void(0);" title="实体商品" rel="#productTab" class="here">实体商品</a><a href="javascript:void(0);" title="优惠活动" rel="#eventTab">优惠活动</a></em><cite></cite></h2>
