...
<title>申请退换货_退换货订单_用户中心_移动商城_中国移动通信</title>
...
<div class="w loc">
	...
	<p class="r"><a href="index.jsp" title="首页">首页</a><samp>&gt;</samp><a href="../person/index.jsp" title="用户中心">用户中心</a><samp>&gt;<samp><a href="../person/returnOrders.jsp" title="退换货订单">退换货订单</a><samp>&gt;<samp><span class="gray">申请退换货</span></p>
	...
	<div class="r wr profile">
		...
		<div class="confirm">
			...
			<div class="ofc">
				...
				<h2 class="h2 h2_r2"><em title="申请退换货">申请退换货</em></h2>
				...
				<form method="post" action="" name="">
					...
					<li>
						<label for="username"><samp>*</samp>订单编号：</label>
						<span class="bg_text"><input type="text" id="orderNumber" name="orderNumber" maxLength="32" vld="{required:true}" /></span>
						<span class="pos"><span class="tip errorTip">用户名为4-20位字母、数字或中文组成，字母区分大小写。</span></span>
					</li>
					<li>
						<label for="reType"><samp>*</samp>退换货类型：</label>
						<span class="word">
							<select name="">
					...
					<li>
						<label for="description" class="alg_t">问题描述：</label>
						<span class="word">
							<textarea name="" rows="4" cols="23" class="are"></textarea>
						</span>
						<span class="pos"><span class="tip okTip">&nbsp;</span></span>
					</li>
					<li>
						<label for="contact">联系人：</label>
						<span class="bg_text"><input type="text" id="contact" name="contact" maxLength="32" vld="{required:true}" /></span>
					</li>
					<li>
					...
					<li><label for="">&nbsp;</label><input type="submit" value="提交" class="hand btn66x23" /></li>
					</ul>
