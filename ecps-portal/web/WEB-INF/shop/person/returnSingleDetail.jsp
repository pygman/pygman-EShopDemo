...
<title>退换货单详情_退换货订单_用户中心_移动商城_中国移动通信</title>
...
<div class="w loc">
	...
	<p class="r"><a href="index.jsp" title="首页">首页</a><samp>&gt;</samp><a href="../person/index.jsp" title="用户中心">用户中心</a><samp>&gt;</samp><a href="../person/returnOrders.jsp" title="退换货订单">退换货订单</a><samp>&gt;<samp><span class="gray">退换货单详情</span></p>
	...
	<div class="r wr profile">
		...
		<div class="confirm">
			...
			<div class="ofc">
				...
				<div class="tool">
					<span class="l f14">订单号：TI57849345&nbsp;&nbsp;订单状态：<span class="orange">处理中</span>&nbsp;&nbsp;申请时间：2011-3-4 05:40:52</span>
					<span class="r"><a href="javascirpt:void(0);" title="取消退换货" class="inb btn96x23b">取消退换货</a></span>
				</div>

				<form method="post" action="" name="">

					<ul class="uls form bg_white">
					<li><label>商品名称：</label><p class="word"><a href="#" title="HTC A510e 3G手机（白色）WCDMA\GSM新野火！Android2.3操作系统，3.2英寸电容屏，500万像素，支持GPS，支持Wifi！">HTC A510e 3G手机（白色）WCDMA\GSM新野火！Android2.3操作系统，3.2英寸电容屏，500万像素，支持GPS，支持Wifi！</a></p></li>
					<li><label>退换货类型：</label><p class="word">退货</p></li>
					<li><label>订单总金额：</label><p class="word">￥1912.00</p></li>
					<li><label>问题描述：</label><p>That 手机外观 not fashion，完全hold不住！</p></li>
					<li><label>联系人：</label><p class="word">李发</p></li>
					<li><label>联系电话：</label><p class="word">13954820955</p></li>
					</ul>
