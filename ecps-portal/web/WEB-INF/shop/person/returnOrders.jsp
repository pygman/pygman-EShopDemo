...
<title>退换货订单_用户中心_移动商城_中国移动通信</title>
...
<div class="w loc">
	...
	<p class="r"><a href="index.jsp" title="首页">首页</a><samp>&gt;</samp><a href="../person/index.jsp" title="用户中心">用户中心</a><samp>&gt;</samp><span class="gray">退换货订单</span></p>
...
<div class="w mt ofc">
	<div class="l wl">
		...
		<div class="box bg_gray">
			...
			<li><a href="../person/returnOrders.jsp" title="退换货订单" class="here">退换货订单</a></li>
	...
	<div class="r wr profile">
		...
		<form method="post" action="" name="">
			...
			<div class="tool">
				查询：<select name=""><option selected value="全部订单" selected>全部订单</option><option value="处理中">处理中</option><option value="已完成">已完成</option></select><input type="text" id="orderSearch" name="orderSearch" onfocus="if(this.value=='请输入订单号/商品名称'){this.value='';this.className='txts'}" onblur="if(this.value==''){this.value='请输入订单号/商品名称';this.className='gray txts'}" value="请输入订单号/商品名称" size="28" class="gray txts" /><input type="submit" value="查 询" class="hand btn66x23" />
			</div>
			...
			<tr>
				...
				<td><var>5479.00</var></td>
				<td>2011-5-9<br />05:04:07</td>
				<td>处理中</td>
				<td class="blue"><a href="../person/returnsSingleDetails.jsp" title="查看详情">查看详情</a><br /><a href="#" title="取消退换">取消退换</a></td>
			</tr>
			<tr>
				<td>H7859454</td>
				<td class="nwp pic">
				...
				<td>2011-5-9<br />05:04:07</td>
				<td>已完成</td>
				<td class="blue"><a href="../person/returnsSingleDetails.jsp" title="查看详情">查看详情</a></td>
			</tr>
			<tr>
				<td>H7859454</td>
				<td class="nwp pic">
				...
				<td>2011-5-9<br />05:04:07</td>
				<td>处理中</td>
				<td class="blue"><a href="../person/returnSingleDetail.jsp" title="查看详情">查看详情</a><br /><a href="#" title="取消退换">取消退换</a></td>
			</tr>
			<tr>
				<td>H7859454</td>
				<td class="img48x20">
				...
				<td>2011-5-9<br />05:04:07</td>
				<td>处理中</td>
				<td class="blue"><a href="../person/returnsSingleDetails.html" title="查看详情">查看详情</a><br /><a href="#" title="取消退换">取消退换</a></td>
			</tr>
			<tr>
				<td>H7859454</td>
				<td class="nwp pic">
