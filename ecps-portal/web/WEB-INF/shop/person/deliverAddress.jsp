...
function modify(shipAddrId){
	$.ajax({
		url:"${path}/user/getAddrById.form",
		type:"post",
		dataType:"text",
		data:{
		...
		success:function(responseText){
			...
			if(jsonObj.tip == "noLogin"){
				window.location.href = "${path}/user/toLogin.form";
			}else if(jsonObj.tip == "success"){
				...
				var defaultAddr = jsonObj.addr.defaultAddr;
				if(defaultAddr == '1'){
...
<div class="w loc">
	...
	<p class="r"><a href="index.jsp" title="首页">首页</a><samp>&gt;</samp><a href="../person/index.jsp" title="用户中心">用户中心</a><samp>&gt;</samp><span class="gray">收货地址</span></p>
	...
	<div class="r wr profile">
		...
		<div class="confirm">
			...
			<div class="ofc">
						...
						<tr>
							...
							<td class="def">
								<c:if test="${addr.defaultAddr == 0 }">
									<a href="${path }/user/setDefaultAddr.form?shipAddrId=${addr.shipAddrId}"  title="设为默认">设为默认</a>
								</c:if>
				...
				<form id="jvForm" action="${path }/user/updateOrSaveAddr.form" method="post">
					...
					<li>
						...
						<span class="bg_text">
						<input type="text" id="shipName" name="shipName" vld="{required:true}" maxLength="100" /></span>
					...
					<li>
						...
						<span class="word">
							...
							<select id="district" name="district">
								...
								<option value="清秀">清秀区</option>
								<option value="二道">二道区</option>
							</select>
						</span>
					</li>
					<li>
					...
					<li>
						...
						<span class="bg_text"><input type="text" id="zipCode" name="zipCode" maxLength="32" vld="{required:true}" /></span>
					</li>
					<li>
