...
<div class="w loc">
	...
	<p class="r"><a href="index.html" title="商城首页">商城首页</a><samp>&gt;</samp><span class="gray">关键词“商务”的搜索结果</span></p>
...
<div class="w ofc mt"> 
	<div class="l wl">
		...
		<h2 class="h2 h2_l"><em title="我的浏览记录">我的浏览记录</em><cite></cite></h2>
	...
	<div class="r wr bg_gray ofc">
		...
		<ul class="uls i_150x150 x4_150x150b">
			<li>
				...
				<dl>
					<!-- dt 10个文字+... -->
					<dt><a href="#" title="摩托罗拉XT319" target="_blank">摩托罗拉摩托罗拉摩托...</a></dt>
					<!-- dt 25个文字+... -->
					<dd class="h40">手手机下单就返下单就返新品上市上手手机下单就就...</dd>
					<dd class="orange">￥3599 ~ ￥4599</dd>
					<dd><a href="#" title="购买裸机" class="inb btn70x21 mr">购买裸机</a><a href="#" title="优惠购机" class="inb btn70x21">优惠购机</a></dd>
				</dl>
