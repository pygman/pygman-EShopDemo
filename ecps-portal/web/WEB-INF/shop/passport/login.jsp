...
$(function(){
	...
	//对非空做一个判断
	$("li .bg_text input").blur(function(){
	...
	//获得登录时错误返回登录页面时的tip代码
	var loginTip = $("#loginTip").val();
	if(loginTip == "cap_error"){
		$("#errorName").show(500);
		$("#errorName").html("验证码错误");
	}else if(loginTip == "user_error"){
		$("#errorName").show(500);
...
<div class="sign">
	...
	<div class="r">
		...
		<form id="jvForm" action="${path }/user/login.form" method="post">
			<ul class="uls form">
			...
			<li><label for="captcha">验证码：</label>
				...
				<img id="captchaImage" src="${path }/user/getImage.form" onclick="changeImage();" class="code" alt="换一张" /><a href="javascript:void(0);" onclick="changeImage();" title="换一张">换一张</a></li>
