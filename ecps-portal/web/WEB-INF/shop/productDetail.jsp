...
$(function(){
	...
	$(".spec a").click(function(){
		$(".spec a").each(function(){
			$(this)http://my.tv.sohu.com/us/63307449/59502355.shtmlremoveClass();
		});
						...
						<c:forEach items="${item.skuList }" var="sku" varStatus="state">
							<c:choose>
								<c:when test="${state.index == 0 }">
									<a href="javascript:void(0);"  class="here" skuId="${sku.skuId }" skuPrice="${sku.skuPrice }" marketPrice="${sku.marketPrice }">
