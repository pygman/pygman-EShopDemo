			...
			if(cssHere == "here"){
				...
				if(fValue != null && fValue != ""){
					if(fType == "price"){
						...
						paraListStr = paraListStr + fValue + ",";
					}
				}
			}
		});
		//alert(prices + "          "+brandId+ "             "+ paraListStr);
		var path = "${path}/item/listItem.form?prices="+prices+"&brandId="+brandId+"&paraListStr="+paraListStr;
		//刷新iframe只需要每次没src赋值即可
		$("#itemListIframe").attr("src", path);
    });
...
<div class="w loc">
	...
	<p class="l"><a href="#" title="商城首页">商城首页</a><samp>|</samp><a href="${path }/user/toPersonIndex.form" title="我的商城">我的商城</a></p>
	...
	<div class="r wr">
		...
		<h2 class="h2 h2_filter mt"><em title="手机商品筛选">手机&nbsp;-&nbsp;商品筛选</em><cite><a href="javascript:void(0);" id="filterRest" title="重置筛选条件">重置筛选条件</a></cite></h2>
			...
			<ul class="uls filter">
				...
				<li><b>价格：</b><p>
					<a href="javascript:void(0);" fType="price" fValue="" class="here">不限</a>
					<a href="javascript:void(0);" fType="price" fValue="1-499">1-499</a>
					<a href="javascript:void(0);" fType="price" fValue="500-599">500-999</a>
					...
					<a href="javascript:void(0);" fType="price" fValue="5000-1000000">5000以上</a>
				</p></li>
				...
				<c:forEach items="${fList }" var="feature">
					<li style="display:none"><b>${feature.featureName }：</b>
						<p>
							<a href="javascript:void(0);" fType="feature" fValue="" class="here">不限</a>
		...
		<iframe id="itemListIframe" src="${path }/item/listItem.form" frameBorder=0 scrolling=no width="100%" height="200%"  ></iframe>
