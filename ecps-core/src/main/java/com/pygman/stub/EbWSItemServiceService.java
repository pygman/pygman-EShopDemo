 ...
 * 2014-10-30T14:28:31.328+08:00
 * Generated source version: 2.4.2
 * 
 */
@WebServiceClient(name = "EbWSItemServiceService", 
                  wsdlLocation = "http://localhost:8080/ecps-portal/services/publishItem?wsdl",
                  targetNamespace = "http://service.ws.pygman.com/") 
public class EbWSItemServiceService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://service.ws.pygman.com/", "EbWSItemServiceService");
    public final static QName EbWSItemServicePort = new QName("http://service.ws.pygman.com/", "EbWSItemServicePort");
    static {
        URL url = null;
        try {
