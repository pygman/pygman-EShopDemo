	...
	<div class="c set">
		...
		<p class="alg_c msg">
			...
			<select id="areaCodeId" name="areaCodeId">
				<ui:permTag src="/${system}/simcard/importSimcard.form?areaCode=851">
					<option value="851">贵阳</option>
				</ui:permTag>
				<ui:permTag src="/${system}/simcard/importSimcard.form?areaCode=854">
					<option value="854">都匀</option>
				</ui:permTag>
				<ui:permTag src="/${system}/simcard/importSimcard.form?areaCode=857">
					<option value="857">毕节</option>
				</ui:permTag>
				<ui:permTag src="/${system}/simcard/importSimcard.form?areaCode=858">
					<option value="858">六盘水</option>
				</ui:permTag>
				<ui:permTag src="/${system}/simcard/importSimcard.form?areaCode=855">
					<option value="855">凯里</option>
				</ui:permTag>
				<ui:permTag src="/${system}/simcard/importSimcard.form?areaCode=852">
					<option value="852">遵义</option>
				</ui:permTag>
				<ui:permTag src="/${system}/simcard/importSimcard.form?areaCode=859">
					<option value="859">兴义</option>
				</ui:permTag>
				<ui:permTag src="/${system}/simcard/importSimcard.form?areaCode=856">
					<option value="856">铜仁</option>
				</ui:permTag>
				<ui:permTag src="/${system}/simcard/importSimcard.form?areaCode=853">
