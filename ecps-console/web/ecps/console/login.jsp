...
<head>
	...
	<!-- 由于订单打印order/preview.form等跳转页面不能使用装饰器，在session过期后转会login.jsp会丢失元数据及资源文件引用 故添加此段，并将login.jsp在装饰其中进行排除配置
...
<div class="sbox">
    ...
    <div class="cont">
        ...
        <form method="post" id="loginForm" action="<%=request.getContextPath()%>/ecps/console/enter.form">
            <ul class="uls set">
