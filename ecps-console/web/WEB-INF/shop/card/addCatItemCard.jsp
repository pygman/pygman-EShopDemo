...
<div class="frameR"><div class="content">
    ...
    <div class="loc icon"><samp class="t12"></samp><fmt:message key='menu.current.loc'/>：<fmt:message key='ItemMgmtMenu.title'/>&nbsp;&raquo;&nbsp;<a href="<c:url value="/${system }/card/listCard.form"/>" title="移动号卡">移动号卡</a>&nbsp;&raquo;&nbsp;<span class="gray">商品分类</span><a href="<c:url value="/${system}/card/listCard.form"/>" title="返回移动号卡" class="inb btn120x20">返回移动号卡</a></div>

    <c:url value="/${system}/item/addCard.form" var="addItem"/>
