...
<div class="loc icon"><samp class="t12"></samp><fmt:message key='menu.current.loc' />：<fmt:message key='ItemMgmtMenu.title' />&nbsp;&raquo;&nbsp;<a href="<c:url value="/${system }/card/listCard.form"/>" title="移动号卡">移动号卡</a>&nbsp;&raquo;&nbsp;<a href="<c:url value="/${system }/item/addCatItemCard.form"/>" title="商品分类">商品分类</a>&nbsp;&raquo;&nbsp;<span class="gray">添加移动号卡</span>
    <a href="<c:url value="/${system }/item/addCatItemCard.form"/>" title="返回移动号卡" class="inb btn120x20">返回移动号卡</a>
</div>
<form action="${path}/card/saveCard.form" name="myForm" id="myForm" method="post">
