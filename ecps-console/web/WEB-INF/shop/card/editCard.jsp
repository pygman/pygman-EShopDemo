...
$(function(){
	...
	$("#catId").change(function(){
		...
		top.location.href="/console/card/chgFeaByCat.form?itemId="+a1+"&catId="+a;
		});
...
<div class="loc icon"><samp class="t12"></samp><fmt:message
	key='menu.current.loc' />:<fmt:message key='ItemMgmtMenu.title' />&nbsp;&raquo;&nbsp;<a href="<c:url value="/${system }/card/listCard.form"/>">移动号卡</a>&nbsp;&raquo;&nbsp;<span class="gray">编辑移动号卡</span><a href="<c:url value="/${system }/card/listCard.form"/>" class="inb btn80x20">返回移动号卡</a></div>
<form action="${path}/card/editSaveCard.form" name="myForm" id="myForm"
	method="post">
...
<iframe src="<c:url value='/${system }/consolelog/top10.form?entityId=${ebItem.itemId}&tableName=EB_ITEM&isCard=y'/>" width="100%" height="400" marginwidth="0" marginheight="0" frameBorder="no" framespacing="0" allowtransparency="true" scrolling="auto"></iframe>
