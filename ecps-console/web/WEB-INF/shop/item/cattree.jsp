...
$(document).ready(function(){
	 var options = { 
				 url:  "${path}/item/cat/assignCatForBrand.form",
	...
	$("#reset").click(function(){
		document.location.href="<c:url value='/${system }/item/brand/listBrand.form'/>";	
	});
});
...
<div class="frameR"><div class="content">
	...
	<div class="loc icon"><samp class="t12"></samp>当前位置：商品管理&nbsp;&raquo;&nbsp;<a href="<c:url value="/${system }/item/brand/listBrand.form"/>" title="品牌管理">品牌管理</a>&nbsp;&raquo;&nbsp;<span class="gray">关联类目</span><a href="<c:url value="/${system }/item/brand/listBrand.form"/>" title="返回品牌管理" class="inb btn120x20">返回品牌管理</a></div>
    <form id="form1" name="form1" action="${path}/item/cat/assignCatForBrand.form" method="post">
		<div class="edit set">
