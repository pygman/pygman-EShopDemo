...
<div id="tab_2">
    ...
    <form id="form1" name="form1" action="${path}/log/login/listBackLandLog.form" method="post">
    ...
    <div class="page_c">
        ...
        <span class="r inb_a">
            <a href="${path}/item/addCatItem.form"  class="btn80x20"><fmt:message key="tag.add"/></a>
        </span>
    </div>
	...
	<table cellspacing="0" summary="" class="tab">
		...
		<tbody>
			...
			<tr>
				...
				<td>
					<c:url value="/log/login/deleteBackLandLogById.form" var="deleteBackLandLogById">
