...
function clickRemove(id,skuId){
	...
	$.ajax({
        type:"POST",
        async: false,
        url:"${path }/item/deleteSkuCheck.form",
        data:"skuId="+skuId,
...
<div class="loc icon"><samp class="t12"></samp><fmt:message key='menu.current.loc'/>：<fmt:message key='ItemMgmtMenu.title' />&nbsp;&raquo;&nbsp;<a href="<c:url value="/${system }/item/listEntity.form"/>" title="实体商品">实体商品</a>&nbsp;&raquo;&nbsp;<span class="gray">编辑规格</span>
    <a href="<c:url value="/${system }/item/itemFrame.form"/>" title="返回实体商品" class="inb btn80x20">返回实体商品</a>
</div>

<form action="${path}/item/editSaveSku.form" name="myForm" id="myForm" method="post">
