...
//==================================================================================================================
	...
	$("input[name='upload444']").click(function(){ 
		var options = {
			...
			url:"${path}/uploads/upload_pic.form",
			type:"post"
		};
        ...
        if(s){
        	...
        	if($("#itemName").val()!="${ebItem.itemName}") {
	      		...
	      		$.ajax({
	                   type:"POST",
	                   async: false,
	                   url:"${path }/item/validJSONName.form",
...
<div class="loc icon"><samp class="t12"></samp><fmt:message key='menu.current.loc'/>:<fmt:message key='ItemMgmtMenu.title' />&nbsp;&raquo;&nbsp;<a href="<c:url value="/${system }/item/listEntity.form"/>" title="实体商品">实体商品</a>&nbsp;&raquo;&nbsp;<span class="gray">编辑商品</span>
    <a href="<c:url value="/${system }/item/listEntity.form"/>" title="返回实体商品" class="inb btn80x20">返回实体商品</a>
</div>
<form action="${path}/item/editSaveItem.form?" name="myForm" id="myForm" method="post">
...
<div id="tab_1" class="edit set">
	...
	<p><label></label>
		...
		<input type='hidden' id='giftImgAction' name='giftImgAction' value='${path}/uploads/upload_pic.form' />
    ...
    <p><label></label>
		...
		<input type='hidden' id='imgSize1Action' name='imgSize1Action' value='${path}/uploads/upload_pic.form' />
...
<%--                         <input class="hand btn60x20" onclick="up(${count.index})" type="button" value="上 移" /><br />
            ...
            <tr>
                <td class="alg_r" colspan="3">
                    ...
                    <input type='hidden' id='imgsUploadAction' name='imgsUploadAction' value='${path}/uploads/upload_pics.form' />
                    <input type='hidden' id='imgsDeleteAction' name='imgsDeleteAction' value='${path}/uploads/upload_delete.form' />
...
<script type="text/javascript">   
	...
	${"itemDesc"}.Config["LinkUploadURL"] = "${path}/uploads/fckUpload.form";
	${"itemDesc"}.Config["ImageUploadURL"] = "${path}/uploads/fckUpload.form?typeStr=Image";
	${"itemDesc"}.Config["FlashUploadURL"] = "${path}/uploads/fckUpload.form?typeStr=Flash";
	${"itemDesc"}.Config["MediaUploadURL"] = "${path}/uploads/fckUpload.form?typeStr=Media";
...
<script type="text/javascript">   
	...
	${"packingList"}.Config["LinkUploadURL"] = "${path}/uploads/fckUpload.form";
	${"packingList"}.Config["ImageUploadURL"] = "${path}/uploads/fckUpload.form?typeStr=Image";
	${"packingList"}.Config["FlashUploadURL"] = "${path}/uploads/fckUpload.form?typeStr=Flash";
	${"packingList"}.Config["MediaUploadURL"] = "${path}/uploads/fckUpload.form?typeStr=Media";
...
<iframe src="<c:url value='/${system }/consolelog/top10.form?entityId=${ebItem.itemId}&tableName=EB_ITEM&isCard=n'/>" width="100%" height="400" marginwidth="0" marginheight="0" frameBorder="no" framespacing="0" allowtransparency="true" scrolling="auto"></iframe>
