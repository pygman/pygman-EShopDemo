...
<div class="loc icon"><samp class="t12"></samp><fmt:message key='menu.current.loc'/>：<fmt:message key='ItemMgmtMenu.title' />&nbsp;&raquo;&nbsp;<a href="<c:url value="/${system }/item/listAudit.form?auditStatus=0"/>" title="<fmt:message key='menu.leftItem.auditList'/>"><fmt:message key='menu.leftItem.auditList'/></a>&nbsp;&raquo;&nbsp;<span class="gray">查看商品</span>
    <a href="<c:url value="/${system }/item/listAudit.form?auditStatus=0"/>" title="返回商品审核" class="inb btn80x20">返回商品审核</a>
</div>
...
<iframe src="<c:url value='/${system }/consolelog/top10.form?entityId=${ebItem.itemId}&tableName=EB_ITEM'/>" width="100%" height="400" marginwidth="0" marginheight="0" frameBorder="no" framespacing="0" allowtransparency="true" scrolling="auto"></iframe>
