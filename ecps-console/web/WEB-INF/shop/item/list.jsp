...
<form id="showForm" action="${path }/item/showItem.form" method="post">
...
<div class="frameR"><div class="content">
    ...
    <h2 class="h2_ch"><span id="tabs" class="l">
        <a id="label6" href="${path}/item/listItem.form&auditStatus=1"   title="全部实体商品" class="nor">全部</a>
        <a id="label4" href="${path}/item/listItem.form?showStatus=1&auditStatus=1"   title="未上架实体商品" class="nor">未上架</a>
        <a id="label5" href="${path}/item/listItem.form?showStatus=0&auditStatus=1"  title="已上架实体商品" class="nor">已上架</a>
    </span></h2>

<form id="form1" name="form1" action="${path}/item/listItem.form" method="post">
   <input type="hidden" name="showStatus" id="showStatus" value="${qc.showStatus }">
    <div class="sch">
        <p>搜索：
				...
				<tr>
					...
					<td>
						...
						<c:if test="${item.showStatus == 1 }">
							<a href="/ecps-console/ecps/console/item/editItem.form?type=1&itemId=2384">编辑</a>
