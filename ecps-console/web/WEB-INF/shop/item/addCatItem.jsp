...
<div class="frameR"><div class="content">
    ...
    <div class="loc icon"><samp class="t12"></samp><fmt:message key='menu.current.loc'/>：<fmt:message key='ItemMgmtMenu.title' />&nbsp;&raquo;&nbsp;<a href="<c:url value="/${system}/item/listEntity.form"/>" title="实体商品">实体商品</a>&nbsp;&raquo;&nbsp;<span class="gray">商品分类</span>
        <a href="<c:url value="/${system}/item/listEntity.form"/>" title="返回实体商品" class="inb btn120x20">返回实体商品</a>
    </div>

    <c:url value="/${system}/item/addItem.form" var="addItem"/>
