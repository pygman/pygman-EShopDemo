	...
	$(document).ready(function(){
		...
		function showResponse(responseText, statusText){ 
			...
			if(obj.result=="success"){
				document.location.href="${base}/activity/listOfferGroup.form";	
			}
		}
	});
	$(document).ready(function(){
...
<div class="frameR"><div class="content">
    ...
    <div class="loc icon"><samp class="t12"></samp><fmt:message key='menu.current.loc'/>：商品管理&nbsp;&raquo;&nbsp;<a href="${base}/activity/listOfferGroup.form" title="营销案管理">营销案管理</a>&nbsp;&raquo;&nbsp;<span class="gray">添加营销案</span>
        <a href="${base}/activity/listOfferGroup.form" class="inb btn120x20">返回营销案管理</a></div>
	<form id="form1" name="form1" action="${base}/activity/addOfferGroup.form" method="post">
         <div class="edit set">
