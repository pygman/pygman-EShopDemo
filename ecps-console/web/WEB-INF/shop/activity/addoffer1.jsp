    ...
    $(document).ready(function(){
		...
		function showResponse(responseText, statusText){ 
			...
			if(obj.result=="success"){
                document.location.href="<c:url value='/ecps/console/activity/listoffer.form'/>?offerGroupId=${offerGroup.offerGroupId }&offerType=1";
			}
		}
	});
...
<div class="frameR"><div class="content">
    ...
    <div class="loc icon"><samp class="t12"></samp>当前位置:商品管理&nbsp;&raquo;&nbsp;<a href="${base}/activity/listOfferGroup.form">营销案管理</a>&nbsp;&raquo;&nbsp;<a href="${base}/activity/listoffer.form?offerGroupId=${offerGroup.offerGroupId }&offerType=1" title="${offerGroup.offerGroupName }的活动档次">活动档次</a>&nbsp;&raquo;&nbsp;<span class="gray">添加档次</span><a href="${base}/activity/listoffer.form?offerGroupId=${offerGroup.offerGroupId }&offerType=1" class="inb btn80x20" title="返回${offerGroup.offerGroupName }的活动档次">返回活动档次</a></div>
