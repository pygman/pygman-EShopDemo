...
<script type="text/javascript">
	...
	function showResponse(responseText, statusText){ 
		...
		if(obj.result=="success"){
			document.location=url="${base}/activity/listAudit.form?auditStatus=${auditStatus}&labelStatus=${labelStatus}";	
		}
	}
...
<div class="frameR"><div class="content">
    ...
    <div class="loc icon"><samp class="t12"></samp>当前位置：商品管理&nbsp;&raquo;&nbsp;<a href="${base}/activity/listAudit.form" title="营销案管理">营销案审核</a>&nbsp;&raquo;&nbsp;<span class="gray">审核营销案</span><a href="${base}/activity/listAudit.form" class="inb btn120x20">返回营销案审核</a></div>
	<form id="form1" name="form1" action="${base}/activity/auditOfferGroup.form" method="post">
         <div class="edit set">
         	<p>
            	<label>营销类型：</label>
            	<c:choose>
    ...
    <div class="edit set"><h2>操作记录</h2></div>
	 <iframe src="${base}/consolelog/top10.form?entityId=${offerGroup.offerGroupId}&tableName=EB_OFFER_GROUP" 
		width="100%" 
		height="400" 
		marginwidth="0" 
		marginheight="0" 
