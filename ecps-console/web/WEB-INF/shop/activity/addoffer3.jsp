...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		function showResponse(responseText, statusText){ 
			...
			if(obj.result=="success"){
				document.location.href="<c:url value='/ecps/console/activity/listoffer.form'/>?offerGroupId=${offerGroup.offerGroupId }&offerType=3";
			}
		}
	});
	...
	function getData(){
		...
		$.ajax({
			type:"post",
			url:"${base}/activity/findItemForActivity.form",
...
<div class="frameR"><div class="content">
    ...
    <div class="loc icon"><samp class="t12"></samp>当前位置:商品管理&nbsp;&raquo;&nbsp;<a href="${base}/activity/listOfferGroup.form">营销案管理</a>&nbsp;&raquo;&nbsp;<a href="${base}/activity/listoffer.form?offerGroupId=${offerGroup.offerGroupId }&offerType=3" title="${offerGroup.offerGroupName }的营销案档次">营销案档次</a>&nbsp;&raquo;&nbsp;<span class="gray">添加档次</span><a href="${base}/activity/listoffer.form?offerGroupId=${offerGroup.offerGroupId }&offerType=3" class="inb btn120x20" title="返回${offerGroup.offerGroupName }的营销案档次">返回营销案档次</a></div>
