		...
		function showResponse(responseText, statusText){ 
			...
			if(obj.result=="success"){
				if($('#opt').val()=='offer'){
					...
					document.location.href="<c:url value='/ecps/console/activity/listoffer.form'/>?offerGroupId=${offer.offerGroupId }&offerType=3";
			}
		}
	});
...
<div class="frameR"><div class="content">
	...
	<div class="loc icon"><samp class="t12"></samp>当前位置：商品管理&nbsp;&raquo;&nbsp;<a href="${path}/activity/listoffer.form?offerGroupId=${offer.offerGroupId }&offerType=3" title="${offer.offerGroup.offerGroupName }的营销案档次">营销案档次</a>&nbsp;&raquo;&nbsp;<span class="gray">编辑档次</span><a href="${path}/activity/listoffer.form?offerGroupId=${offer.offerGroupId }&offerType=3" class="inb btn120x20" title="返回${offer.offerGroup.offerGroupName }的营销案档次">返回营销案档次</a></div>
