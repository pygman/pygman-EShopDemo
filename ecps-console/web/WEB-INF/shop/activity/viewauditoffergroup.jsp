...
<div class="frameR"><div class="content">
    ...
    <div class="loc icon"><samp class="t12"></samp><fmt:message key='menu.current.loc'/>：商品管理&nbsp;&raquo;&nbsp;<a href="${base}/activity/listAudit.form" title="营销案审核">营销案审核</a>&nbsp;&raquo;&nbsp;<span class="gray">查看营销案</span>
        <a href="${base}/activity/listAudit.form" class="inb btn120x20">返回营销案审核</a></div>
