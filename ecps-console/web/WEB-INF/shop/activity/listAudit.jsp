    ...
    function doIt(ajaxData,type){
        ...
        if(result){
         ...
         if(!result){
             ...
             if(${labelStatus==0}) {
                   window.location.href ="${base}/activity/listAudit.form?labelStatus=0";
            }
          if(${labelStatus==1}) {
                   window.location.href ="${base}/activity/listAudit.form?auditStatus=0&labelStatus=1";
            }
          if(${labelStatus==2}) {
                   window.location.href ="${base}/activity/listAudit.form?auditStatus=2&labelStatus=2";
            }
            if(${labelStatus==3}) {
                   window.location.href ="${base}/activity/listAudit.form?auditStatus=1&labelStatus=3";
...
<form id="form1" name="form1" action="${base}/activity/listOfferGroup.form" method="post">
    ...
    <span id="tabs" class="l">
        <a href="${base}/activity/listAudit.form?labelStatus=0" title="全部营销案" class="nor" id="label0" >全部</a>
        <a href="${base}/activity/listAudit.form?auditStatus=0&labelStatus=1"title="待审核营销案" class="nor" id="label1">待审核</a>
        <a href="${base}/activity/listAudit.form?auditStatus=2&labelStatus=2"title="审核不通过营销案" class="nor" id="label2">审核不通过</a>
        <a href="${base}/activity/listAudit.form?auditStatus=1&labelStatus=3"title="已审核营销案" class="nor" id="label3">已审核</a>
    </span>
    </h2>
	...
	<table cellspacing="0" summary="" class="tab">
		...
		<tbody>
			...
			<tr>
				...
				<td>
                    <a href="${base}/activity/viewOfferGroup.form?offerGroupTag=audit&offerGroupId=${offerGroup.offerGroupId}" title="查看">查看</a>	
                    <c:if test="${labelStatus==0}">
                        <a href="${base}/activity/checkOfferGroup.form?offerGroupId=${offerGroup.offerGroupId}&labelStatus=0">审核</a>
                    </c:if>
                    <c:if test="${labelStatus==1}">
                        <a href="${base}/activity/checkOfferGroup.form?offerGroupId=${offerGroup.offerGroupId}&auditStatus=0&labelStatus=1">审核</a>
                    </c:if>
                    <c:if test="${labelStatus==2}">
                        <a href="${base}/activity/checkOfferGroup.form?offerGroupId=${offerGroup.offerGroupId}&auditStatus=2&labelStatus=2">审核</a>
                    </c:if>
                    <c:if test="${labelStatus==3}">
                        <a href="${base}/activity/checkOfferGroup.form?offerGroupId=${offerGroup.offerGroupId}&auditStatus=1&labelStatus=3">审核</a>
                    </c:if>
                    ...
                    <c:if test="${labelStatus==0}">
                    	<c:if test='${offerGroup.showStatus==0}'>
                    		<ui:permTag src="/${system}/static/toPublishJsp.form">
