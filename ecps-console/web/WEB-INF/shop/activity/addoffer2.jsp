...
<script type="text/javascript">
	...
	$(document).ready(function(){
	    ...
	    function validateData(formData, jqForm, options){
			...
			var periodinfo = $("#period").attr("info");
			var periodreg = new RegExp("^([1-9][0-9]{0,1})$"); 
			if(!periodreg.test(periodvalue) && periodvalue != ""){
				result = false;
				alert(periodinfo);
				return false;
			} else if (OTvalue==""){
				result = false;
				alert($("#period").attr("emptyTip"));
				return false;
			}
		...
		function showResponse(responseText, statusText){ 
			...
			if(obj.result=="success"){
				document.location.href="<c:url value='/ecps/console/activity/listoffer.form'/>?offerGroupId=${offerGroup.offerGroupId }&offerType=2";
			}
		}
	});
...
<div class="frameR"><div class="content">
    ...
    <div class="loc icon"><samp class="t12"></samp>当前位置:商品管理&nbsp;&raquo;&nbsp;<a href="${path}/activity/listOfferGroup.form">营销案管理</a>&nbsp;&raquo;&nbsp;<a href="${path}/activity/listoffer.form?offerGroupId=${offerGroup.offerGroupId }&offerType=2" title="${offerGroup.offerGroupName }的营销案档次">营销案档次</a>&nbsp;&raquo;&nbsp;<span class="gray">添加档次</span><a href="${path}/activity/listoffer.form?offerGroupId=${offerGroup.offerGroupId }&offerType=2" class="inb btn120x20" title="返回${offerGroup.offerGroupName }的营销案档次">返回营销案档次</a></div>

    <form id="form111" name="form111" action="${base}/activity/addActivity.form" method="post">
        <div class="edit set">
           ...
           <p><label><samp>*</samp>开始日期:</label>&nbsp;&nbsp;&nbsp;<input type="text" id="validBeginStr" name="validBeginStr" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" value="" class="text20 state date" reg="^\d{4}-\d{2}-\d{2} \d{2}:\d{2}:\d{2}$" tip="请选择开始日期"/>
            ...
            <p><label class="alg_t">套餐名称:</label>&nbsp;&nbsp;&nbsp;<textarea id="offerName" name="offerName" value="" rows="4" cols="45" class="are" reg="^[a-zA-Z0-9\u4e00-\u9fa5,\r\n]{0,50}$" tip="必须是中英文或数字字符,可以输入英文逗号或回车，长度5-50"></textarea>
            	<span class="pos"></span>
            </p>
         </div>
        ...
        <div class="edit set">
            ...
            <table cellspacing="0" summary="" class="tab">
                ...
                <tbody>
                    <tr>
                        <td>
                        	<samp>*</samp><input type="text" name="offerTerm" id="offerTerm" class="text20" size="5" maxlength="2" info="业务协议期格式不正确" emptyTip="业务协议期不能为空"/>
                        </td>
