...
<script type="text/javascript">
	...
	function batchStart(){
		...
		form.action="${base}/ptlUser/batchUpdatePtlUserStatus.form?status=1";
		form.submit();
	}
	function batchStop(){
		if(!isChecked()){
		...
		var form = document.getElementById("form1");
		form.action="${base}/ptlUser/batchUpdatePtlUserStatus.form?status=0";
		form.submit();
	}
...
$(document).keydown(function(event) {
    ...
    function searchList(){
		...
		var form = document.getElementById("form1");
		form.action="${base}/ptlUser/ptlUserList.form";
		form.submit();
    }
</script>
</head>
...
<form id="form1" name="form1" action="${base}/ptlUser/ptlUserList.form" method="post">
	<div class="sch">
		<p>
	...
	<table cellspacing="0" summary="" class="tab">
		...
		<tbody>
			<c:forEach items='${pagination.list}' var="user">
             <c:url value="/${system}/ptlUser/ptlUserInfoDetail.form" var="info">
        ...
        <c:url value="/${system}/ptlUser/updatePtlUserStatus.form" var="start">
            <c:param name="id" value="${user.ptlUserId}"/>
			<c:param name="status" value="1"/>
        </c:url>
        <c:url value="/${system}/ptlUser/updatePtlUserStatus.form" var="stop">
            <c:param name="id" value="${user.ptlUserId}"/>
