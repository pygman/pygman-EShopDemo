...
<head>
    ...
    <script type="text/javascript">
     function startStatus(){
		var form = document.getElementById("form1");
         form.action="${base}/ptlUser/updatePtlUserInfoStatus.form";
		 form.submit();
	}
	function stop(){
		var form = document.getElementById("form1");
    ...
    function returnPtlUserList(){
        ...
        form.action="${base}/ptlUser/returnPtlUserList.form";
		form.submit();
	}
    function gotoPage(addrPageNo){
        ...
        $("#form3").action="${base}/ptlUser/ptlUserInfoDetail.form";
        $("#form3").submit();
    }
...
<div class="frameR"><div class="content">
    ...
    <div class="loc icon"><samp class="t12"></samp>当前位置：<fmt:message key='EbPtlUserMgmtMenu.title'/>&nbsp;&raquo;&nbsp;<span class="gray" title="会员详细信息页面">会员详细信息页面</span>
        <c:url value="/${system}/ptlUser/ptlUserList.form" var="ptUserList">
