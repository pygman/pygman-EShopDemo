...
$(function(){	
	...
	switch(isCall){
	 ...
	 case "0":$("#label2").attr("class","here");break;
	 case "1":$("#label3").attr("class","here");break;
...
<div class="frameR"><div class="content">
    ...
    <h2 class="h2_ch">
      <span id="tabs" class="l">
        ...
        <a id="label2" href="${path}/order/listOrderPay.do?assignee=noPaidOrderer&isCall=0"   title="未外呼" class="nor">未付款待外呼</a>  
   ...
   <table cellspacing="0" summary="" class="tab" id="myTable">
    ...
    <c:forEach items="${tbList }" var="tb">
	    <tr>
		    ...
		    <td><a href="${path }/order/viewOrderDetail.do?orderId=${tb.order.orderId}&taskId=${tb.taskId}">查看</a></td>
	    </tr>
    </c:forEach>
