...
<div class="frameR"><div class="content">
	...
	<div class="loc icon"><samp class="t12"></samp>
		...
		<c:if test="${tableName=='EB_SIMCARD' }">
			...
			<a href="<c:url value="/${system }/simcard/listSimCard.form?saleStatus=1"/>" title="号卡列表">号卡列表</a>&nbsp;&raquo;&nbsp;
