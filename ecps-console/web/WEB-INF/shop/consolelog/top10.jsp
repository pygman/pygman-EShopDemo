        ...
        <td class="alg_r" colspan="4">
        	<c:choose>
        		<c:when test="${tableName=='EB_GROUPON' }">
        			<a href="javascript:void(0);" onclick="top.window.location.href='${path}/groupon/more.form';">查看更多&gt;&gt;</a>
        		</c:when>
        		<c:when test="${tableName=='EB_SECKILL' }">
        			<a href="javascript:void(0);" onclick="top.window.location.href='${path}/secKill/more.form';">查看更多&gt;&gt;</a>
        		</c:when>
        		<c:otherwise>
        			<a href="javascript:void(0);" onclick="top.window.location.href='${path}/consolelog/more.form?entityId=${entityId}&tableName=${tableName }&isCard=${isCard }';">查看更多&gt;&gt;</a>
        		</c:otherwise>
        	</c:choose>        	           
        </td>
    </tr>
